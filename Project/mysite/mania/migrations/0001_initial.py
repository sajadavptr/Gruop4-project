    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_refrence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mania.booking')),
            ],
        ),
        migrations.CreateModel(
            name='Court',
            fields=[
                ...
                ('court_admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='booking',
            name='court',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mania.court'),
        ),
